        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <h3 class="text-lg font-bold text-gray-800 mb-4">Management Tools</h3>
                    
                    <div class="grid grid-cols-1 gap-3">
                        <a href="{{ route('employees.create') }}" class="flex items-center p-4 bg-gray-50 hover:bg-indigo-50 rounded-lg border border-gray-100 hover:border-indigo-200 transition group">
                            ...
                            <div class="ml-3">
                                <p class="font-bold text-gray-800 group-hover:text-indigo-700">Add Employee</p>
                                <p class="text-xs text-gray-500">Create new account</p>
                            </div>
                        </a>

                        <a href="{{ route('employees.index') }}" class="flex items-center p-4 bg-gray-50 hover:bg-emerald-50 rounded-lg border border-gray-100 hover:border-emerald-200 transition group">
                            ...
                            <div class="ml-3">
                                <p class="font-bold text-gray-800 group-hover:text-emerald-700">Manage Salaries</p>
                                <p class="text-xs text-gray-500">Allowances & Deductions</p>
                            </div>
                        </a>

                        <a href="{{ route('leaves.manage') }}" class="flex items-center p-4 bg-gray-50 hover:bg-orange-50 rounded-lg border border-gray-100 hover:border-orange-200 transition group">
                            ...
                            <div class="ml-3">
                                <p class="font-bold text-gray-800 group-hover:text-orange-700">Approve Leaves</p>
                ...
                <div class="lg:col-span-2 bg-white rounded-xl shadow-sm border border-gray-100 p-6">
                    <div class="flex justify-between items-center mb-6">
                        <h3 class="text-lg font-bold text-gray-800">Live Attendance Feed</h3>
                        <a href="{{ route('attendance.index') }}" class="text-xs font-bold text-indigo-600 hover:underline">View All &rarr;</a>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                                ...
                                <tr class="hover:bg-gray-50 transition">
                                    <td class="px-4 py-3">
                                        <div class="flex items-center">
                                            ...
                                            @endif
                                            <div>
                                                <p class="font-bold text-gray-800">{{ $log->employee->user->name }}</p>
                                                <p class="text-xs text-gray-400">{{ $log->employee->position }}</p>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="px-4 py-3 text-center">
                                        <span class="px-2 py-1 rounded-full text-xs font-bold {{ $log->status == 'Late' ? 'bg-red-100 text-red-600' : 'bg-green-100 text-green-600' }}">
                                            {{ $log->status }}
                                        </span>
                                    </td>
                                </tr>
                        ...
                        @if($recentAttendance->isEmpty())
                            <div class="text-center py-10">
                                <p class="text-gray-400">No activity recorded today.</p>
                            </div>
                        @endif
                    </div>
                </div>
            ...
            <!-- 3. ADMIN PERSONAL PAYSLIPS (Updated Style) -->
            <div class="mt-8">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    @if(isset($adminEmployee) && $myPayrolls->isNotEmpty())
                        <div class="overflow-x-auto">
                            <!-- UPDATED TABLE STYLE TO MATCH EMPLOYEE DASHBOARD -->
                            <table class="w-full text-left text-sm text-gray-600">
                                ...
                                <tbody class="divide-y divide-gray-50">
                                    ...
                                    <tr class="hover:bg-gray-50 transition">
                                        ...
                                        <td class="px-6 py-4 text-center">
                                            <a href="{{ route('payroll.download', $payroll->id) }}" class="inline-flex p-2 bg-gray-100 rounded-lg text-gray-600 hover:bg-indigo-100 hover:text-indigo-600 transition" title="Download PDF">
                                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    @else
                        <div class="p-6 text-center py-12">
                            <p class="text-gray-500 font-medium">No personal payroll records found.</p>
                        </div>
                    @endif
                </div>
            </div>
