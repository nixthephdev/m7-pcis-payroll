                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-3 group">
                        ...
                        <div class="hidden lg:block">
                            <h1 class="font-bold text-lg leading-tight tracking-wide transition"><span class="text-red-500">M</span><span style="color:#38bdf8; text-shadow: 0 0 8px rgba(56,189,248,0.6);">7</span><span class="text-white group-hover:text-indigo-200 transition"> PCIS</span></h1>
